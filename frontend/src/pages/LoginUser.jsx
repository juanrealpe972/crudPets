...
function LoginUser() {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        const URL = "http://localhost:4002/v1/login";
        const data = {
            email: email,
            password: password,
        };
    ...
    return (
        <div
            ...
            style={{ backgroundImage: `url(${ImagenUser})`, backgroundRepeat: "no-repeat", backgroundPosition: 'center', }}
        >
            ...
            <form onSubmit={handleSubmit} className='w-full max-w-sm mt-96 pt-24'>
                ...
                <button type='submit' className="h-[40px] w-[90%] bg-blue-950 rounded-3xl text-white py-2 ml-5 px-4 hover:bg-blue-900">Ingresar</button>
            </form>
        </div>
    );
}
